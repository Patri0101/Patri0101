...
import net.mcreator.thefuture.world.features.TovarnaFeature;
...
public class TheFutureModFeatures {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, TheFutureMod.MODID);
