...
public class RobotEntity extends Monster {
	...
	public RobotEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheFutureModEntities.ROBOT.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(TheFutureModEntities.ROBOT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> (world.getDifficulty() != Difficulty.PEACEFUL
						&& Monster.isDarkEnoughToSpawn(world, pos, random) && Mob.checkMobSpawnRules(entityType, world, reason, pos, random)));
		DungeonHooks.addDungeonMob(TheFutureModEntities.ROBOT.get(), 180);
	}
